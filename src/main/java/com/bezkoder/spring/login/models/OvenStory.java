...
@Entity
@Table(name = "ovenstorypizza_menu")
public class OvenStory {
	@Id
	public int food_id;
	...
	public OvenStory(int food_id, String food_name, String food_cost, String food_categorie, String food_disc,
			String food_image) {
		super();
